			...
			return function (b, c, e) {
				if (c) d("div.dtr-modal-content").empty().append(e());
					...
					var f = function () {
						...
						g = d('<div class="dtr-modal"/>').append(d('<div class="dtr-modal-display"/>').append(d('<div class="dtr-modal-content"/>').append(e())).append(d('<div class="dtr-modal-close">×</div>').click(function () {
							f()
